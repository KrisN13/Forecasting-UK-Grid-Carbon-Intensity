...
temp = pd.read_parquet(r"..\data\processed\uk_temp_hourly.parquet")
...
df_preds.to_parquet("../data/predictions/ci_predictions.parquet")
print("DataFrame saved to ../data/predictions/ci_predictions.parquet")
...
plt.savefig("../assets/ci_actual_vs_pred_feb2024.png", dpi=150)
plt.show()
